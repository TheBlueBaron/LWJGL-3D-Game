package com.rhj.lwjgl.terrains;
...
public class Terrain {
	...
	public float getHeightOfTerrain(float worldX, float worldZ) {
		...
		float answer;
		if(xCoord <= (1 - zCoord)) {
			answer = Maths.baryCentric(new Vector3f(0.0f, heights[gridX][gridZ], 0.0f), new Vector3f(1.0f,
							heights[gridX + 1][gridZ], 0.0f), new Vector3f(0.0f,
							heights[gridX][gridZ + 1], 1.0f), new Vector2f(xCoord, zCoord));
		} else {
			answer = Maths.baryCentric(new Vector3f(1.0f, heights[gridX + 1][gridZ], 0.0f), new Vector3f(1.0f,
							heights[gridX + 1][gridZ + 1], 1.0f), new Vector3f(0.0f,
							heights[gridX][gridZ + 1], 1.0f), new Vector2f(xCoord, zCoord));
		}
